...
public class A_for {
    ...
    public void testForExample1() {
        ...
        /* 설명. 문제 상황 인식 및 분석
         * 1. 반복할 내용
         *  -n번째 학생의 이름을 입력받기 위한 안내 문구 출력
         *  -n번째 학생의 이름을 Scanner로 입력 받아 변수에 저장
         *  -위 변수에 저장한 이름을 출력.
         * 2. 반복할 횟수
         *  - n = 10회
         * */
        ...
        int count = 5;
        for (int i = 1; i <= count ; i++ ) {       //{는 범위(scope)가 있다는 뜻이다.
            //n번째 학생의 이름을 입력받기 위한 안내 문구 출력
            System.out.println(" 번째 학생의 이름을 입력해주세요");
            //n번째 학생의 이름을 Scanner로 입력 받아 변수에 저장
            String student = sc.nextLine();     //student가 for의 지역변수로 살아남
            //위 변수에 저장한 이름을 출력.
    ...
    public void testForExample2() {
        ...
        /* 필기. 결과를 누적시켜 담아줄 변수 선언 */        //누적연산 accum
         ...
         * 1. 반복할 내용
         *  -변수에 1씩 증가하는 값을 저장하기.
         *  -sum에 위의 값을 누적해서 덧셈하기.
         * 2. 반복할 횟수
         *  - n = 10회
         * 3. 반복하지 않을 내용
         *  - 누적 덧셈의 결과를 담을 sum 변수 초기화하기.
         *  - sum 변수에 담긴 최종 값 출력하기.
         * */
...
//            sum2 += num;      //표현
    ...
    public void testForExample3() {
        ...
        /* 설명. 문제 상황 인식 및 분석
         * 1. 반복할 내용
         *  -변수에 1씩 증가(random2회 까지)하는 값을 저장하기.
         *  -sum에 위의 값을 누적해서 덧셈하기.
         * 2. 반복할 횟수
         *  - n = random2회
         * 3. 반복하지 않을 내용
         *  - 랜덤수(random2) 추출
         *  - 누산 결과 저장용 변수(sum3) 선언 및 초기화
         *  - 결과 출력(sout)
         * */

        int random2 = (int) (Math.random() * 6) + 5;        //5 - 10 난수
        System.out.println("random2 : " + random2);

        int sum3 = 0;

        for (int count = 1; count <= random2; count++) {
            sum3 += count;
        }

        System.out.println("1부터 " + random2 + "까지의 합은 : " + sum3);
    }
...
//        int sum = 0;
        ...
        System.out.println(min + "부터 " + max + "까지 더한 값 = " + sum);
    }
    ...
    public void printSimpleGugudan() {
        ...
        int dan = sc.nextInt();      // ex) 1 -> 1단, 4 -> 4단
