...
public class Application {
    ...
    public static void main(String[] args) {
       ...
       * */
        ...
        User user1 = new User();        //값이 없는 기본 생성자
        System.out.println(user1.getInfo());

        /*목차. 2. id, pwd, name 3개 필드를 초기화하는 매개변수 있는 생성자를 호출해 인스턴스 생성 후 필드값 출력*/
        User user2 =  new User("user01", "pass01", "홍길동");      //매개변수 있는 생성자
        System.out.println(user2.getInfo());

        /*목차. 3. 모든 필드를 초기화하는 생성자를 호출해 인스턴스 생성 후 필드값 출력 */
        /*목차. java.util.Date는 뒤에서 따로 다룰 예정이다.
        * 기본생성자로 인스턴스를 생성하면 현재 프로그램이 동작하는 운영체제 상의 날짜/시간 정보를 이용해 인스턴스를 생성한다.
        * */
        User user3 = new User("user02", "pass", "이순신", new Date());
        System.out.println(user3.getInfo());

        /*목차. 4. 복사 생성자를 호출하여 인스턴스 생성 후 필드값 출력*/
        /*설명. 위에서 만든 user3과 여기서 만든 user4는 동일한 필드값을 가지지만, 실제로는 다른 인스턴스다.*/
