...
public class OverLoadingTest {
    ...
    /* 필기.
     *  메소드의 시그니쳐란?
     *  public void method(int num) {} 이라는 메소드의 메소드명(method)과 파라미터 선언부(int num) 부분을 시그니쳐라고 부른다.
    ...
    //메서드 시그니처가 아예 똑같다. - 컴파일 에러
//    public void test() {}

    //접근 제어자는 메서드 오버로딩 성립요건에 해당하지 않는다. - 컴파일 에러
//    private void test() {}

    //반환형은 메서드 오버로딩 성립요건에 해당하지 않는다. - 컴파일 에러
//    public int test() {return 0;}

    //매개 변수의 개수(유무)에 따른 오버 로딩 성립한다. - 시그니처의 이름이 같고,
    public void test(int a) {}

    //매개변수의 이름은 메서드 오버로딩 성립 요건에 해당하지 않는다. - 컴파일 에러
//    public void test(int b) {}

    //매개변수의 개수에 따른 오버로딩이 성립한다.
    public void test(int a, int b) {}

    //매개변수의 타입에 따른 오버로딩 성립한다.
    public void test(int a, String s) {}

    //매개변수의 순서에 따른 오버로딩 성립한다. - 순서가 다르니까 다른 것으로 인식한다.
    public void test(String s, int a) {}

    /*설명.
    * 메서드 오버로딩은 매우 중요한 개념이므로 반드시 숙제할 수 있도록 해야 한다.
    * 뒤에서 배울 오버라이딩(overriding)이라는 개념과 비교하는 면접 질문이 단골 질문으로 등장하니
    * 오버라이딩 학습 후에 이 두 개념을 비교해서 특징을 살펴보자!*/
}
