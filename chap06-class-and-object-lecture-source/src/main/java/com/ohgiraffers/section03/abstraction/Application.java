...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* 설명. 추상화 기법을 이용해서 객체를 설계하고 이를 바탕으로 클래스를 작성한 뒤 객체를 상호작용 시켜보자 */
         ...
         *  3. 자동차는 처음에 멈춘 상태로 대기하고 있는다.        //변수의 초기값.
         ...
         *   1. 카레이서 클래스
         *    - 속성(data -> 필드) : 자동차
         *    - 행위(behavior -> 메서드) : 시동을걸어라, 엑셀레이터를 밟아라, 브레이크를 밟아라, 시동을 꺼라.
         *   2. 자동차 클래스
         *    - 속성(data -> 필드) : 시동상태, 현재시속
         *    - 메소드(behavior -> 메서드) : 시동을걸어라, 앞으로 가라, 멈춰라, 시동을 꺼라
         * */

        /*목차. 1. 카레이서(당신)가 한 명 등장한다.*/
        CarRacer myRacer = new CarRacer();

        /*목차. 2. 입력받은 메뉴의 번호에 따라 카레이서가 동작한다.*/
        Scanner sc = new Scanner(System.in);

        while(true) {       //true가 들어갔다는 것은 무한루프라는 뜻이다.
            ...
            System.out.println("[sys] 원하시는 메뉴의 번호를 눌러주세요:");
            int no = sc.nextInt();

            switch(no) {
                case 1: myRacer.startUp(); break;
                case 2: myRacer.stepAccelerator(); break;
                case 3: myRacer.stepBrake();break;
                case 4: myRacer.turnOff(); break;
                case 9: System.out.println("[sys] 프로그램을 종료합니다..."); break;
                default: System.out.println("[sys] 잘못된 번호를 입력하셨습니다!"); break;
            }
