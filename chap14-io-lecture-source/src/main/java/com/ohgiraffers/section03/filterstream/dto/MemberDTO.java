...
public class MemberDTO implements Serializable {
    ...
    private String id;
    private transient String pwd;       //transient는 특정 필드를 직렬화 과정에서 제외하는 키워드다.
    private String name;
    ...
    public boolean equals(Object o) {
        ...
        return age == memberDTO.age && gender == memberDTO.gender && Double.compare(point, memberDTO.point) == 0 && Objects.equals(id, memberDTO.id) && Objects.equals(pwd, memberDTO.pwd) && Objects.equals(name, memberDTO.name) && Objects.equals(email, memberDTO.email);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, pwd, name, email, age, gender, point);
    }
}
