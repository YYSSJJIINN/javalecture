...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        /* 목차. 1-1. 동일한 범위 내에서 동일한 변수명을 가질 수 없다. */ //왜? = 컴퓨터는 중복을 극도로 싫어함.
        int age = 20;
//        int age = 20;       // 동일한 변수명을 가지므로 에러 발생함

        /* 목차. 1-2. 예약어(키워드)는 사용이 불가능하다. */
//        int true = 1;         // 예약어 사용 불가
//        int for = 20;         // 예약어 사용 불가
//        int int = 3;

        /* 목차. 1-3. 변수명은 대소문자를 구분(case-sensitive)한다. */
        int Age = 20;         // 위에서 만든 age와 다른 것으로 취급한다.
        int True = 10;          // 예약어 True와 다른 것으로 취급한다.

        /* 목차. 1-4. 변수명은 숫자로 시작할 수 없다. */ //숫자는 맨 앞자리에만 안오면 괜찮다.
...
//        int sh@rp = 20;         // 사용 가능한 특수문자 외에는 사용 불가능
        int _age = 20;            // 언더스코어(언더바. dash의 shift버전)는 사용 가능함. 처음도 가능하고 중간이나 끝에도 가능함
        ...
        /* 목차. 2-2. 캐멀케이스. 변수명이 합성어로 이루어진 경우 첫 단어는 소문자, 두 번째 시작 단어는 대문자로 시작한다. */
        /* 필기. 자바에서는 클래스명만 유일하게 대문자로 시작한다. */ //Application 123, 문자열 String
        int maxAge = 20;        // 최대 나이
        int minAge = 10;        // 최소 나이

        /* 목차. 2-3. 스네이크케이스. 단어와 단어 사이의 연결을 언더스코어(_)로 하지 않는다. */
