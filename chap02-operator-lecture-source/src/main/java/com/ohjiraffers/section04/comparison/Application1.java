package com.ohjiraffers.section04.comparison;
...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
         *  비교연산자의 종류      대입연산자는 다 뒤에
         *  '==' : 왼쪽의 피연산자와 오른쪽의 피연산자가 같으면 true 다르면 false를 반환
         *  '!=' : 왼쪽의 피연산자와 오른쪽의 피연산자가 다르면 true 같으면 false를 반환
         *  '>'  : 왼쪽의 피연산자가 오른쪽의 피연산자보다 크면 true 아니면 false를 반환 =>초과
         *  '>=' : 왼쪽의 피연산자가 오른쪽의 피연산자보다 크거나 같으면 true 아니면 false를 반환 =>이상
         *  '<'  : 왼쪽의 피연산자가 오른쪽의 피연산자보다 작으면 true 아니면 false를 반환 =>미만
         *  '<=' : 왼쪽의 피연산자가 오른쪽의 피연산자보다 작거나 같으면 true 아니면 false를 반환 =>이하
         * */
        ...
        System.out.println("========= 정수 리터럴 비 교 =====");
        System.out.println("(inum1과 inum2가 같은지 비교) = " + (inum1 == inum2));             //true
        System.out.println("(inum1과 inum2가 다른지 비교) = " + (inum1 != inum2));             //false ! =
        System.out.println("(inum1이 inum2보다 큰지 비교 = " + (inum1 > inum2));               //false
        System.out.println("(inum1이 inum2보다 크거나 같은지 비교 = " + (inum1 >= inum2));     //true
        System.out.println("(inum1이 inum2보다 작은지 비교 = " + (inum1 < inum2));             //false
        ...
        /* 설명. 논리 리터럴은 ==와 != 비교만 가능하고 나머지 대소비교는 불가능(컴파일 에러)*/
...
//        System.out.println("str1이 str2보다 작은거나 같은지 비교 : " + (str1 <= str2));
        ...
        System.out.println("str5 = " + str5);   //java
