package com.ohjiraffers.section01.arithmetic;
...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /* 필기. 산술 연산자:
        *  산술 연산자는 주로 사칙연산과 관련된 연산자로 가장 기본적이면서도 많이 사용되는 연산자다.
        *  연산의 실행이 가능하기 위해 필요한 값이나 변수가 두 개인 '이항 연산자'로 분류되며,
