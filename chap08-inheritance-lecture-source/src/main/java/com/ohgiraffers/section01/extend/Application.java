...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /*설명.
        * Car클래스를 하나 만들 것이다.
        * 자동차의 역할을 수행할 수 있는 객체로, 기본적인 기능만 수행할 수 있도록 제한적으로 설계했다.
        * */

        /*목차. 1. Car 인스턴스 생성 후 메서드 호출*/
        Car car = new Car();
        ...
        /*설명. 위 5개 메서드를 호출했을 때 모두 정상적으로 동작하는 것을 확인할 수 있다.
        * 하지만, 자동차라고 하기에는 아직 기능들이 너무 초라하고 일반화 되어있다.
        * 상속의 예시로 사용하기 위해 몇 가지 특수 목적을 가진 자동차들을 조금 더 추가해볼 예정입니다.
        * FireCar, RacingCar를 추가할 것이다.*/

        /*목차. 2. FireCar 인스턴스 생성 후 메서드 호출*/
        ...
        /*목차. 3. 상속(inheritance)는 곧 확장(extend)이다. 부모가 가지지 못한 추가 기능도 자식은 수행할 수 있다.*/
        fireCar.sprayWater();

        /*목차. 4. RacingCar 인스턴스 생성 후 메서드 호출*/
